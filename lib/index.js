...
(function() {
  var _, check_email, cheerio, fetch_email, get_email, get_link, get_link_poll, get_list, gn, make_post_request, make_request, q, qs, request, set_email;
  ...
  get_link = function(subject, contains_text, token) {
    ...
    gn.get_list(token).then(function(data) {
      ...
      return gn.fetch_email(token, email_id).then(function(data) {
        ...
        return link_text.resolve(elem.attr('href') || elem.text());
      });
    }, function(error) {
